                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre_platillo" name="nombre_platillo" placeholder="" value="{{old('nombre_platillo')}}" required pattern="^[a-zA-Z ]*$">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="precio_platillo" name="precio_platillo" placeholder="" value="{{old('precio_platillo')}}" required>
                            <!-- <div class="valid-feedback">DATO VALIDO.</div> -->
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="receta_platillo" name="receta_platillo" placeholder="" value="{{old('receta_platillo')}}" required pattern="^[\w\-\s]+$">
                            <!-- <div class="valid-feedback">DATO VALIDO.</div> -->
                            <div class="invalid-feedback">LOS CAMPOS NO PUEDEN ESTAR VACIOS.INTRODUZCA SOLO LETRAS</div>
